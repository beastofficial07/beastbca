...
function mapError(msg: string, data?: any) {
  if (msg.includes('No account') || msg.includes('not found')) {
    return {
      text: 'No account with this email.',
      hint: 'Check spelling or register first.',
      link: {
        label: 'Register →',
        href: '/register',
      },
  ...
  if (
    ...
    return {
      ...
      hint: 'Check your inbox and click the verification link.',
      link: {
  ...
  if (
    ...
    return {
      text: 'Wrong password.',
      hint: 'Check caps lock or reset below.',
      link: {
...
export default function LoginPage() {
  ...
  const onSubmit = async (d: F) => {
    ...
    try {
      ...
      setFormError(
        mapError(errorMsg, e.response?.data)
      );
  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center bg-background overflow-hidden">
      ...
      <div
        ...
        style={{
          background:
            'radial-gradient(ellipse at center,transparent 20%,hsl(222 47% 6% / 0.95) 70%)',
        }}
      />
      ...
      <div className="relative z-10 w-full max-w-md mx-4">
        ...
        {chosen && (
          <div className="flex justify-center mb-4 opacity-0 animate-slide-up">
            ...
            <div
              className={`inline-flex items-center gap-2 px-4 py-2 rounded-full bg-gradient-to-r ${chosen.color} border-gold-subtle`}
            >
              ...
              <span className="font-heading text-sm uppercase tracking-[0.15em] text-primary">
                {chosen.label}
              </span>
            ...
            <AnimatePresence>
              ...
              {formError && (
                ...
                >
                  ...
                  {formError.hint && (
                    <p className="text-muted-foreground font-display text-[11px]">
                      {formError.hint}
                    </p>
                  )}
                  ...
                  {formError.link && (
                    <Link
                      href={formError.link.href}
                      className="text-primary underline font-heading block pt-1"
                    >
